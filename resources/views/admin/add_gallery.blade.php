...
<body>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <h2 style="text-align: center;">Thêm thư viện hình ảnh</h2>
                        </header>
                    <form action="{{URL::to('/insert-gallery/'.$pro_id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class ="row">
                            ...
                            <div class="col-md-6" >
                                <input type="file" name="file[]" id="file" accept="image/*" multiple class="form-control">
                                <span id="error_gallery"></span>

                            </div>
                            <div class="col-md-3" style="align:right" >
                                <input type="submit" name="upload" value="Thêm ảnh" class="btn btn-success">
    ...
    <script type="text/javascript">
        ...
        //         error +='<p>Files ảnh không được lớn hơn 2MB</p>';
        //       }
        //       if(error==''){
